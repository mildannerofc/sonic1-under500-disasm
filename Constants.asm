...
bgm_GHZ2:	equ ((ptr_mus14-MusicIndex)/4)+bgm__First
bgm_GHZ3:	equ ((ptr_mus15-MusicIndex)/4)+bgm__First
bgm_LZ2:		equ ((ptr_mus1A-MusicIndex)/4)+bgm__First
bgm_LZ3:		equ ((ptr_mus1B-MusicIndex)/4)+bgm__First
bgm_MZ2:		equ ((ptr_mus16-MusicIndex)/4)+bgm__First
bgm_MZ3:		equ ((ptr_mus17-MusicIndex)/4)+bgm__First
bgm_SLZ2:	equ ((ptr_mus1C-MusicIndex)/4)+bgm__First
bgm_SLZ3:	equ ((ptr_mus1D-MusicIndex)/4)+bgm__First
bgm_SYZ2:	equ ((ptr_mus18-MusicIndex)/4)+bgm__First
bgm_SYZ3:	equ ((ptr_mus19-MusicIndex)/4)+bgm__First
bgm_SBZ2:	equ ((ptr_mus1E-MusicIndex)/4)+bgm__First
bgm_SBZ3:	equ ((ptr_mus1F-MusicIndex)/4)+bgm__First
bgm_Options:	equ ((ptr_mus20-MusicIndex)/4)+bgm__First
