...
v_tween_timer:	equ $FFFFF7A0	; palette cycling in Special Stage - time until next change (2 bytes)
v_obj31ypos:	equ $FFFFF7A4	; y-position of object 31 (MZ stomper) (2 bytes)
v_hudscrollpos:	equ $FFFFF7A6	; x-position for HUD scrolling (1 byte)
