...
;		mappings	object		subtype	frame	VRAM setting
    ...
    dbug    Map_Monitor,    id_Monitor,    7,    9,    $680 ; S Monitor
    dbug    Map_Monitor,    id_Monitor,    4,    6,    $680 ; Shield
    dbug    Map_Monitor,    id_Monitor,    3,    5,    $680 ; Speed Shoes
    dbug    Map_Monitor,    id_Monitor,    5,    7,    $680 ; Invincibility
    dbug    Map_Monitor,    id_Monitor,    6,    8,    $680 ; 10 rings
    dbug    Map_Monitor,    id_Monitor,    2,    4,    $680 ; Sonic 1UP
    dbug    Map_Monitor,    id_Monitor,    1,    3,    $680 ; Eggman
    dbug    Map_Monitor,    id_Monitor,    8,    10,    $680 ; Goggles
	...
	dbug	Map_Bonus,	id_HiddenBonus,	3,	3,	$84B6
	dbug	Map_Bonus,	id_HiddenBonus,	2,	2,	$84B6
	dbug	Map_Bonus,	id_HiddenBonus,	1,	1,	$84B6
	dbug	Map_Sign,	id_Signpost,	0,	0,	$0D00
	dbug	Map_Eggman,	id_BossGreenHill,	1,	1,	$3E00
	dbug	Map_Pri,	id_Prison,	2,	2,	$3E00
	dbug	Map_Pri,	id_Prison,	1,	1,	$3E00
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Fire,	id_LavaBall,	0,	0,	$345
	...
	dbug	Map_Bonus,	id_HiddenBonus,	1,	1,	$84B6
	dbug	Map_Sign,	id_Signpost,	0,	0,	$0D00	
	dbug	Map_Eggman,	id_BossMarble,	1,	1,	$3E00
	dbug	Map_Pri,	id_Prison,	2,	2,	$3E00
	dbug	Map_Pri,	id_Prison,	1,	1,	$3E00
	@MZend:
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Bonus,	id_HiddenBonus,	1,	1,	$84B6
	dbug	Map_Sign,	id_Signpost,	0,	0,	$0D00	
	dbug	Map_Eggman,	id_BossStarLight,	1,	1,	$3E00
	dbug	Map_SSawBall,	id_ExplosionBomb,	1,	1,	$3E00
	dbug	Map_BSBall,	id_BossSpikeball,	1,	1,	$3E00
	dbug	Map_Pri,	id_Prison,	2,	2,	$3E00
	dbug	Map_Pri,	id_Prison,	1,	1,	$3E00
	@SLZend:
