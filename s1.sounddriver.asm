...
PSGA:		incbin	"sound/psg/psgA.bin"
PSGB:		incbin	"sound/psg/psgB.bin"
PSGC:		incbin	"sound/psg/psgC.bin"
PSGD:		incbin	"sound/psg/psgD.bin"
; ---------------------------------------------------------------------------
...
; Music data
; ---------------------------------------------------------------------------
Music81:	include	"sound/music/greengrove.asm"
		even
Music82:	include	"sound/music/LabyrinthZoneSMS.asm"
		even
Music83:	include	"sound/music/RedVolcanoAct1.asm"
		even
Music84:	include	"sound/music/Modern Cyber City.asm"
		even
Music85:	include	"sound/music/Casino2P.asm"
		even
Music86:	include	"sound/music/Wily2.asm"
		even
Music87:	include	"sound/music/S3Inv.asm"
		even
Music88:	include	"sound/music/Mus88 - Extra Life.asm"
		even
Music89:	include	"sound/music/PocketSpecial.asm"
		even
Music8A:	include	"sound/music/TitleSuperstars.asm"
		even
Music8B:	include	"sound/music/Mus8B - Ending.asm"
		even
Music8C:	include	"sound/music/Sonic 3D Blast - Boss Unused.asm"
		even
Music8D:	include	"sound/music/FinalShowdownSK.asm"
		even
Music8E:	include	"sound/music/ActClearS3.asm"
		even
Music8F:	include	"sound/music/GameOverS3.asm"
		even
Music90:	include	"sound/music/NoWay.asm"
		even
Music91:	include	"sound/music/DoodleChampion.asm"
		even
Music92:	include	"sound/music/Mus92 - Drowning.asm"
		even
Music93:	include	"sound/music/Mus93 - Get Emerald.asm"
		even
Music94:	include	"sound/music/AzureLakeS3.asm"
		even
Music95:	include	"sound/music/BridgeIslandAct1.asm"
		even
Music96:	include	"sound/music/EndlessMarble.asm"
		even
Music97:	include	"sound/music/MGZ1.asm"
		even
Music98:	include	"sound/music/CasinoPark.asm"
		even
Music99:	include	"sound/music/BalloonPark.asm"
		even
Music9A:	include	"sound/music/SM_Unused.asm"
		even
Music9B:	include	"sound/music/LagoonAmy.asm"
		even
Music9C:	include	"sound/music/ChromeGadget.asm"
		even
Music9D:	include	"sound/music/DCZ SMPS Port.asm"
		even
Music9E:	include	"sound/music/CosmicAngelZone.asm"
		even
Music9F:	include	"sound/music/EggFortressAct1.asm"
		even
