...
ptr_GM_Menu:	bra.w	GM_Menu	; Credits ($20)
...
;		jsr SHC       ; This code can be used if in SHC.
	...
	Tit_LoadText:
		...
		move.w	#$700,(v_demolength).w ; run title screen for $696 frames
...
LevSel_SndTest:
		...
		bhs.s	LevSel_Right
		moveq	#$63,d0		; if sound test	moves below 0, set to $63
...
M_Card_GHZ:	dc.b 11 			; GREEN HILL
		dc.b $F7, 5, 0, $26, $AC	; L
		dc.b $F7, 5, 0, $46, $BC	; U
		dc.b $F7, 5, 0, 8, $CC		; C
		dc.b $F7, 1, 0, $20, $DC	; I
		dc.b $F7, 5, 0, $0C, $E4	; D
		dc.b $F7, 0, 0, $56, $F4	; Space
		dc.b $F7, 5, 0, $1C, $4	; H
		dc.b $F7, 1, 0, $20, $14	; I
		dc.b $F7, 5, 0, $26, $1C	; L
		dc.b $F7, 5, 0, $26, $2C	; L
