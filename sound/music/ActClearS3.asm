Act_Clear_Header:
	...
	smpsHeaderVoice     Act_Clear_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $08

	smpsHeaderDAC       Act_Clear_DAC
	smpsHeaderFM        Act_Clear_FM1,	$0C, $12
	smpsHeaderFM        Act_Clear_FM2,	$0C, $16
	smpsHeaderFM        Act_Clear_FM3,	$0C, $16
	smpsHeaderFM        Act_Clear_FM4,	$0C, $16
	smpsHeaderFM        Act_Clear_FM5,	$0C, $1A
	smpsHeaderPSG       Act_Clear_PSG1,	$F4, $03, $00, fTone_0C
	smpsHeaderPSG       Act_Clear_PSG2,	$F4, $03, $00, fTone_0C
	smpsHeaderPSG       Act_Clear_PSG3,	$F4, $05, $00, fTone_0C

; DAC Data
Act_Clear_DAC:
	dc.b	dSnare, $06, dKick, dKick, dSnare, dKick, dKick, dSnare, dKick, dSnare, dKick, dKick
	dc.b	dSnare, dKick, dKick, dSnare, dKick, $01, nRst, dKick, dKick, nRst, dKick, dMidTimpani
	dc.b	$06, dLowTimpani, dVLowTimpani, dMidTimpani, dLowTimpani, dVLowTimpani, dMidTimpani, dLowTimpani, dVLowTimpani, dSnare
	smpsStop
