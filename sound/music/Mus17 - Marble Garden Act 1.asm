Marble_Garden_Zone_Act_1_Header:
	smpsHeaderStartSong 1
	smpsHeaderVoice     Marble_Garden_Zone_Act_1_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $06

	smpsHeaderDAC       Marble_Garden_Zone_Act_1_DAC
	smpsHeaderFM        Marble_Garden_Zone_Act_1_FM1,	$00, $0C
	smpsHeaderFM        Marble_Garden_Zone_Act_1_FM2,	$00, $0D
	smpsHeaderFM        Marble_Garden_Zone_Act_1_FM3,	$00, $0D
	smpsHeaderFM        Marble_Garden_Zone_Act_1_FM4,	$00, $0D
	smpsHeaderFM        Marble_Garden_Zone_Act_1_FM5,	$00, $12
	smpsHeaderPSG       Marble_Garden_Zone_Act_1_PSG1,	$E8, $02, $00, $00
	smpsHeaderPSG       Marble_Garden_Zone_Act_1_PSG2,	$E8, $02, $00, $00
	smpsHeaderPSG       Marble_Garden_Zone_Act_1_PSG3,	$E8, $02, $00, $00

; FM1 Data
Marble_Garden_Zone_Act_1_FM1:
	smpsSetvoice        $01
	smpsModSet          $0D, $01, $02, $06
	smpsPan             panCenter, $00

Marble_Garden_Zone_Act_1_Loop04:
	...
	dc.b	nFs2, $18
	smpsLoop            $00, $0A, Marble_Garden_Zone_Act_1_Loop04

Marble_Garden_Zone_Act_1_Loop05:
	...
	dc.b	nFs2, $18
	smpsLoop            $00, $03, Marble_Garden_Zone_Act_1_Loop05
	dc.b	nB2, $08, nB3, $04, nB3, $08, nRst, $04, nB2, $08, nRst, $04
	dc.b	nB3, $08, nB2, $06, nRst, $2E, nB2, $08, nB3, $04, nB3, $08
	dc.b	nRst, $04, nB2, $08, nRst, $04, nB3, $08, nB2, $06, nRst, $18
	dc.b	nC3, $16
	smpsJump            Marble_Garden_Zone_Act_1_FM1

; FM2 Data
Marble_Garden_Zone_Act_1_FM2:
	smpsSetvoice        $00
	smpsModSet          $0D, $01, $02, $06
	smpsPan             panCenter, $00
	...
	smpsJump            Marble_Garden_Zone_Act_1_FM2

; FM3 Data
Marble_Garden_Zone_Act_1_FM3:
	smpsSetvoice        $02
	smpsModSet          $0D, $01, $02, $06
	smpsPan             panLeft, $00
	dc.b	nRst, $08, nB4, $04
...
Marble_Garden_Zone_Act_1_Loop02:
	smpsSetvoice        $02
	dc.b	nRst, $08, nB4, $04
	smpsSetvoice        $08
	dc.b	nB2, $03, nRst, $05, nB2, $04
	...
	smpsSetvoice        $09
	dc.b	nFs5, $24
	smpsLoop            $00, $04, Marble_Garden_Zone_Act_1_Loop02

Marble_Garden_Zone_Act_1_Loop03:
	smpsSetvoice        $05
	...
	smpsLoop            $00, $03, Marble_Garden_Zone_Act_1_Loop03
	dc.b	nE4, $08, nE4, $04, nB3, $06, nRst, nE4, nRst, nG4, $08, nE4
	dc.b	$06, nRst, nB3, $28, nEb4, $08, nEb4, $04, nB3, $06, nRst, nEb4
	dc.b	nRst, nFs4, $08, nEb4, $06, nRst, nRst, $10, nE4, $18
	smpsJump            Marble_Garden_Zone_Act_1_FM3

; FM4 Data
Marble_Garden_Zone_Act_1_FM4:
	smpsSetvoice        $02
	smpsModSet          $0D, $01, $02, $06
	smpsPan             panRight, $00
	dc.b	nRst, $08, nE5, $04
...
Marble_Garden_Zone_Act_1_Loop00:
	smpsSetvoice        $02
	dc.b	nRst, $08, nE5, $04
	smpsSetvoice        $08
	dc.b	nE3, $03, nRst, $05, nE3, $04
	...
	smpsSetvoice        $09
	dc.b	nB4, $24
	smpsLoop            $00, $04, Marble_Garden_Zone_Act_1_Loop00

Marble_Garden_Zone_Act_1_Loop01:
	smpsSetvoice        $05
	...
	smpsLoop            $00, $03, Marble_Garden_Zone_Act_1_Loop01
	dc.b	nG4, $08, nG4, $04, nE4, $06, nRst, nG4, nRst, nB4, $08, nG4
	dc.b	$06, nRst, nE4, $28, nFs4, $08, nFs4, $04, nEb4, $06, nRst, nFs4
	dc.b	nRst, nB4, $08, nFs4, $06, nRst, nRst, $10, nA4, $18
	smpsJump            Marble_Garden_Zone_Act_1_FM4

; FM5 Data
Marble_Garden_Zone_Act_1_FM5:
	dc.b	nRst, $0B

Marble_Garden_Zone_Act_1_Jump00:
	smpsSetvoice        $00
	smpsModSet          $0D, $01, $02, $06
	smpsPan             panCenter, $00
	dc.b	nRst, $60, nRst, nRst, nRst, nRst, $0C, nCs4, nCs4, $06, nRst, nB3
	...
	dc.b	nFs5, $0C, nE5, nEb5, nCs5, $06, nRst, nRst, $0C, nEb5, $06, nRst
	dc.b	$12, nB4, $24, nRst, $18
	smpsJump            Marble_Garden_Zone_Act_1_Jump00

; DAC Data
Marble_Garden_Zone_Act_1_DAC:
	dc.b	dKick, $0C, dKick, $08, dKick, $04, dSnare, $0C, dKick, $08, dKick, $0C
	dc.b	dKick, $04, dKick, $08, dKick, $04, dSnare, $18, dKick, $0C, dKick, $08
	dc.b	dKick, $04, dSnare, $0C, dKick, $08, dKick, $10, dKick, $08, dKick, $04
	dc.b	dSnare, $0C, dSnare, $08, dSnare, $04, dKick, $0C, dKick, $08, dKick, $04
	dc.b	dSnare, $0C, dKick, $08, dKick, $0C, dKick, $04, dKick, $08, dKick, $04
	dc.b	dSnare, $18, dKick, $0C, dKick, $08, dKick, $04, dSnare, $0C, dKick, $08
	dc.b	dKick, $10, dKick, $04, dKick, dKick, dSnare, $0C, dKick
	smpsLoop            $00, $07, Marble_Garden_Zone_Act_1_DAC
	smpsJump            Marble_Garden_Zone_Act_1_DAC

; PSG1 Data
Marble_Garden_Zone_Act_1_PSG1:
	smpsStop

; PSG2 Data
Marble_Garden_Zone_Act_1_PSG2:
	smpsStop

; PSG3 Data
Marble_Garden_Zone_Act_1_PSG3:
	smpsStop

Marble_Garden_Zone_Act_1_Voices:
;	Voice $00
;	$38
