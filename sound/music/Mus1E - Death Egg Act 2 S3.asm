Death_Egg_Act_2_Header:
	smpsHeaderStartSong 1
	smpsHeaderVoice     Death_Egg_Act_2_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $00

	smpsHeaderDAC       Death_Egg_Act_2_DAC
	smpsHeaderFM        Death_Egg_Act_2_FM1,	$00, $0F
	smpsHeaderFM        Death_Egg_Act_2_FM2,	$00, $0C
	smpsHeaderFM        Death_Egg_Act_2_FM3,	$00, $0F
	smpsHeaderFM        Death_Egg_Act_2_FM4,	$00, $0F
	smpsHeaderFM        Death_Egg_Act_2_FM5,	$00, $16
	smpsHeaderPSG       Death_Egg_Act_2_PSG1,	$E8, $02, $00, $00
	smpsHeaderPSG       Death_Egg_Act_2_PSG2,	$E8, $02, $00, $00
	smpsHeaderPSG       Death_Egg_Act_2_PSG3,	$E8, $02, $00, $00
...
Death_Egg_Act_2_Loop0E:
	...
	smpsLoop            $00, $02, Death_Egg_Act_2_Loop0E
	smpsSetvoice        $03

Death_Egg_Act_2_Loop0F:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop0F

Death_Egg_Act_2_Loop10:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop10
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nRst, nG4, nA4, nRst, nBb4, $12

Death_Egg_Act_2_Loop11:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop11

Death_Egg_Act_2_Loop12:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop12
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nG4, nRst, nC5, nRst, nBb4, nRst, nG4
	smpsJump            Death_Egg_Act_2_FM1
...
Death_Egg_Act_2_Loop0C:
	...
	smpsLoop            $00, $02, Death_Egg_Act_2_Loop0C

Death_Egg_Act_2_Loop0D:
	...
	smpsLoop            $00, $02, Death_Egg_Act_2_Loop0D
	smpsJump            Death_Egg_Act_2_FM2
...
Death_Egg_Act_2_Loop0A:
	...
	dc.b	nBb3, $06, nF3, nFs3, nD3, nEb3, nE3, nBb2, nB2, nG2, nAb2, nE2
	dc.b	nFs2
	smpsLoop            $00, $02, Death_Egg_Act_2_Loop0A

Death_Egg_Act_2_Loop0B:
	dc.b	nRst, $60
	smpsLoop            $00, $08, Death_Egg_Act_2_Loop0B
	smpsJump            Death_Egg_Act_2_FM3
...
Death_Egg_Act_2_Loop05:
	...
	dc.b	nE3, nRst
	smpsLoop            $00, $02, Death_Egg_Act_2_Loop05
	smpsSetvoice        $03

Death_Egg_Act_2_Loop06:
	dc.b	nAb2, $06, nBb2, nC3, nEb3
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop06

Death_Egg_Act_2_Loop07:
	dc.b	nBb2, $06, nC3, nD3, nF3
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop07
	dc.b	nRst, $60, nRst, $06, nG4, $12, nF4, $06, nRst, nE4, nRst, nG4
	dc.b	nRst, nE4, nF4, $05, nRst, $07, nG4, $12

Death_Egg_Act_2_Loop08:
	dc.b	nAb2, $06, nBb2, nC3, nEb3
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop08

Death_Egg_Act_2_Loop09:
	dc.b	nBb2, $06, nC3, nD3, nF3
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop09
	dc.b	nRst, $60, nRst, $06, nG4, $12, nF4, $06, nRst, nE4, nRst, nG4
	dc.b	nE4, nRst, nA4, nRst, nG4, nRst, nE4
	smpsJump            Death_Egg_Act_2_FM4

; FM5 Data
Death_Egg_Act_2_FM5:
	dc.b	nRst, $10

Death_Egg_Act_2_Jump00:
	smpsModSet          $0D, $01, $02, $06
	smpsPan             panCenter, $00

Death_Egg_Act_2_Loop00:
	smpsSetvoice        $00
	dc.b	nRst, $18, nG4, $0B, nRst, $0D, nF4, $0B, nRst, $25, nE4, $0C
	dc.b	nF4, nRst, nG4, nRst, nF4, $24, nRst, $18, nG4, $0B, nRst, $0D
	dc.b	nF4, $0B, nRst, $25, nE4, $0C, nF4, nRst, nG4, nRst, nF4, nRst
	...
	dc.b	$06, nBb4, nA4, nRst, nG4, nA4, nG4, nRst, nF4, nG4, nF4, nRst
	dc.b	nE4, nF4, nE4, nRst
	smpsLoop            $00, $02, Death_Egg_Act_2_Loop00
	smpsSetvoice        $03

Death_Egg_Act_2_Loop01:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop01

Death_Egg_Act_2_Loop02:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop02
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nRst, nG4, nA4, nRst, nBb4, $12

Death_Egg_Act_2_Loop03:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop03

Death_Egg_Act_2_Loop04:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, Death_Egg_Act_2_Loop04
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nG4, nRst, nC5, nRst, nBb4, nRst, nG4
	smpsJump            Death_Egg_Act_2_Jump00

; DAC Data
Death_Egg_Act_2_DAC:
	dc.b	dKick, $18, dSnare, dKick, dSnare
	smpsLoop            $00, $17, Death_Egg_Act_2_DAC
	dc.b	dSnare, $0C, dSnare, nRst, $48
	smpsJump            Death_Egg_Act_2_DAC

; PSG1 Data
Death_Egg_Act_2_PSG1:
	smpsStop

; PSG2 Data
Death_Egg_Act_2_PSG2:
	smpsStop

; PSG3 Data
Death_Egg_Act_2_PSG3:
	smpsStop

Death_Egg_Act_2_Voices:
;	Voice $00
;	$10
